...
- (void)mainViewDidLoad {
	...
	READ_GROWL_PREF_INT(BEZEL_SIZE_PREF,@"BezelNotificationView", &sizePref);
...
- (IBAction)preferenceChanged:(id)sender {
	...
	if (sender == radio_PositionD) {
		...
		WRITE_GROWL_PREF_INT(BEZEL_POSITION_PREF, &positionPref, @"BezelNotificationView");
		...
		WRITE_GROWL_PREF_INT(BEZEL_SIZE_PREF, &sizePref, @"BezelNotificationView");
	} else if (sender == slider_Opacity) {
		opacityPref = [slider_Opacity intValue];
		[text_Opacity setStringValue:[NSString stringWithFormat:@"%d\%",opacityPref]];
		WRITE_GROWL_PREF_INT(BEZEL_OPACITY_PREF, &opacityPref, @"BezelNotificationView");
	}
