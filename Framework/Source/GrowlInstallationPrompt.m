...
#define DEFAULT_INSTALLATION_WINDOW_TITLE NSLocalizedStringFromTableInBundle(@"Growl Installation Recommended", GROWL_INSTALLATION_STRINGS, [NSBundle bundleForClass:[self class]], @"Growl installation window title")
#define DEFAULT_UPDATE_WINDOW_TITLE       NSLocalizedStringFromTableInBundle(@"Growl Update Available", GROWL_INSTALLATION_STRINGS, [NSBundle bundleForClass:[self class]], @"Growl update window title")

#define DEFAULT_INSTALLATION_EXPLANATION NSLocalizedStringFromTableInBundle(@"This program displays information via Growl, a centralized notification system that enables applications to unobtrusively inform the user about potentially important information.  Growl is not currently installed; to see Growl notifications from this and other applications, you must install it.  No download is required.", GROWL_INSTALLATION_STRINGS, [NSBundle bundleForClass:[self class]], @"Default Growl installation explanation")
#define DEFAULT_UPDATE_EXPLANATION       NSLocalizedStringFromTableInBundle(@"This program displays information via Growl, a centralized notification system that enables applications to unobtrusively inform the user about potentially important information.  A version of Growl is currently installed, but this program includes an updated version of Growl.  It is strongly recommended that you update now.  No download is required.", GROWL_INSTALLATION_STRINGS, [NSBundle bundleForClass:[self class]], @"Default Growl update explanation")
